...
<div style="display:flex; align-items:center; gap:18px; margin: 10px 0 24px 0; flex-wrap:wrap;">
  <img src="{{ '/assets/img/avatar.jpg' | relative_url }}" alt="Avatar" style="width:120px; height:120px; object-fit:cover; border-radius:50%;">
  <div>
    <p style="margin:0 0 8px 0;"><strong>Aquí queda mi ciencia</strong></p>
